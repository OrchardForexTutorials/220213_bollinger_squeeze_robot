...
This is a simple example expert for both MQL4 and MQL5

The strategy in use waits for the bollinger bands to contract such that the distance from
the highest upper to  the lowest lower is less than a specified range over a specified period.
Then when price closes ooutside the range the expert trades a breakout
